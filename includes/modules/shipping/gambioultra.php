 ...
 */
    function __construct() {
      ...
      $this->sort_order = defined('MODULE_SHIPPING_GAMBIOULTRA_SORT_ORDER') or '';
      $this->icon = '';
      $this->tax_class = defined('MODULE_SHIPPING_GAMBIOULTRA_TAX_CLASS') or '';
      $this->enabled = defined('MODULE_SHIPPING_GAMBIOULTRA_STATUS') ? filter_Var(MODULE_SHIPPING_GAMBIOULTRA_STATUS, FILTER_VALIDATE_BOOLEAN) : false;
 ...
 */
    ...
    function quote($method = '') {
      ...
      if ($error == true) $this->quotes['error'] = MODULE_SHIPPING_GAMBIOULTRA_INVALID_ZONE;
    ...
    function install() {
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) VALUES ('MODULE_SHIPPING_GAMBIOULTRA_STATUS', 'True', '6', '0', 'xtc_cfg_select_option(array(\'True\', \'False\'), ', now())");
      ...
      for ($i = 1; $i <= $this->num_zones; $i++) {
        ...
        xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_SHIPPING_GAMBIOULTRA_COST_" . $i ."', '3:8.50,7:10.50,99:20.00', '6', '0', now())");
